    ...
    try:
        ...
        for row in proyectos:
            for i, col in enumerate(seleccionadas):
                if col == "cantidad_prototipos" and isinstance(row[i], (int, float, Decimal)):
                    total_prototipos += row[i]
                if col == "tiempo_estimado" and isinstance(row[i], (int, float, Decimal)):
                    total_tiempo += row[i]

        resumen_proyectos = (cantidad_proyectos, total_prototipos, total_tiempo)
